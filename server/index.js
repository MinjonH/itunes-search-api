...
app.get('/itunes/:term_media', async(req, res) => {
    //Split termmedia at the comma (,)
    const term_media = req.params.term_media.split(',');
...
//DELETE function to delete items from favourites
